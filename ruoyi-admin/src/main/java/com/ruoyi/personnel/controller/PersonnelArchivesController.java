...
public class PersonnelArchivesController extends BaseController
{
    ...
    @Log(title = "人事档案花名册", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, PersonnelArchives personnelArchives)
    {
        ...
        util.exportExcel(response, list, "人事档案花名册数据");
    }
    ...
    @Log(title = "人事档案花名册", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "人事档案花名册", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "人事档案花名册", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
