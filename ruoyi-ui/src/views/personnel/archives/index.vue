  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-collapse accordion>
        ...
        <el-collapse-item title="其他信息">
          ...
          <el-form-item label="上家单位" prop="previousEmployer">
            <el-input
          ...
          <el-form-item label="晋升调动" prop="promotionInfo">
            <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="户籍性质" prop="hukouType">
          <el-radio-group v-model="form.hukouType">
            <el-radio
              v-for="dict in dict.type.personnel_archives_hukoutype"
              :key="dict.value"
              :label="dict.value"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除花名册编号为"' + ids + '"的数据项？').then(function() {
